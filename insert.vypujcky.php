                    ...
                    <div class="card bg-dark text-white" >
                        <div class="card-body">
                            ...
                            <form action="insert.vypujcky.php" method="post">
                                ...
                                <label for="vypujceni">Den Vypůjčení:</label>
                                    <?php 
                                ...
                                <label for="vraceni">Den Vrácení:</label>
...
<?php
    ...
    if(isset($_POST["user"])){
        ...
        $query="SELECT k.pocet - (SELECT count(*) FROM vypujceni v WHERE v.id_kniha=k.id AND v.stav='aktivni') dostupne
                FROM katalog k WHERE k.id =$kniha";
        $result = mysqli_query($connect,$query);
        if(!$result){
        ...
        if($row['dostupne'] > 0) {
            ...
            echo "<script> alert('vsechny vytisky vypujceny'); </script>"
            ;
        }
